              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_stock="SELECT * FROM vendeurs , demande , colis_stock WHERE vendeurs.vend_id=demande.vendeur_id AND demande.dmd_id=colis_stock.dmd_id AND vendeurs.email='$email'";
