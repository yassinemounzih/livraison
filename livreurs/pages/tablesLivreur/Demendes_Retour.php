               ...
               <a href="indexLivreur.php?Chargement_Destinataire"><button type="button"  class="btn btn-outline-primary">Chargement Destinataire <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM livreurs , colis_livre WHERE livreurs.livreur_id=colis_livre.livreur_id AND livreurs.email_livreur='$email' ANd colis_livre.etat_lv='Annulé, demande de retour' ";
                  ...
                  <tr>
                    ...
                    <ul>
                     ...
                     <a href="indexLivreur.php?colis_Retours_Envoyés=<?php echo $id_livre; ?>">
