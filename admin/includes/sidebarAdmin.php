   ...
   <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index1.php?dashboardAdmin" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="indexA.php?contact_Admin" class="nav-link">Contact</a>
      </li>
    </ul>
       ...
       <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-footer">
            ...
            <a href="pages/examplesAdmin/logout.php"  class="btn btn-default btn-flat float-right">Sign out</a>
          </li>
        </ul>
      </li>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/indexAdmin.php?nouvelle_ramassage" class="nav-link">
               ...
               <li class="nav-item">
                <a href="pages/indexAdmin.php?no_ramasse" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mes Demande</p>
                </a>
              </li>
         ...
         <li class="nav-item has-treeview">
            <a href="pages/indexAdmin.php?verifier_colis_livree" class="nav-link">
            ...
            <a href="#" class="nav-link">
              ...
              <p>
               Stock
                  ...
                  <li class="nav-item has-treeview">
            <a href="pages/indexAdmin.php?livraison_au_stock" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            <a href="pages/indexAdmin.php?Reçu_parAS" class="nav-link">
