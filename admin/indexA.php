...
<?php 
    ...
    if(!isset($_SESSION['admin'])){
        ...
        echo "<script>window.open('pages/examplesAdmin/login.php','_self')</script>";
 ...
 <!-- Navbar -->
  ...
  <!-- Content Wrapper. Contains page content -->
         ...
         if(isset($_GET['contact_Admin'])){
          ...
          if(isset($_GET['contact_vendeurs'])){
                        
                        include("chats/contact_vendeurs.php");
          ...
          if(isset($_GET['contact_livreurs'])){
           ...
           if(isset($_GET['chat_vendeurs'])){
                        
                        include("chats/chat_vendeurs.php");
