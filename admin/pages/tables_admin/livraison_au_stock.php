  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <a href="indexAdmin.php?livraison_au_stock"><button type="button"  class="btn btn-primary">Livraison a partir au Stock <span class="badge badge-danger right">0</span> </button></a> 
                 
                  <a href="indexAdmin.php?demande_vérifier"><button type="button"  class="btn btn-outline-primary"> Les Demande Livraisons (Vérifier) <span class="badge badge-danger right">0</span> </button></a> 
