              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_colis="SELECT * FROM demande , vendeurs , colis_livre WHERE vendeurs.vend_id=demande.vendeur_id and demande.dmd_id=colis_livre.dmd_id and colis_livre.dmd_id='$id_colis' AND demande.type='Livraison'  order by 1 DESC";
                    
                    $run_colis=mysqli_query($con,$get_colis);
    
                     $i=0;
                  
                        
                    while($rows_demande=mysqli_fetch_array($run_colis)){
