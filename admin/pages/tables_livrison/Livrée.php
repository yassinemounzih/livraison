          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <a href="indexAdmin.php?Livrée"><button type="button"  class="btn btn-primary">Livrée <span class="badge badge-danger right">0</span></button></a>
               ...
               <br>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM demande , vendeurs , colis_livre , livreurs WHERE vendeurs.vend_id=demande.vendeur_id AND demande.dmd_id=colis_livre.dmd_id AND livreurs.livreur_id=colis_livre.livreur_id  AND colis_livre.etat_lv='Livré' ";
