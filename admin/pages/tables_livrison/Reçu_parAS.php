 ...
 <input type="button" name="submitbtn" id="btn" class="btn btn-info" value="Multiple Update" />                   
              ...
              <div class="card-body">
                ...
                <a href="indexAdmin.php?Reçu_parAS"><button type="button"  class="btn btn-primary">Reçu par MPacket <span class="badge badge-danger right">0</span> </button></a> 
               ...
               <a href="indexAdmin.php?Chargement_Destinataire"><button type="button"  class="btn btn-outline-primary">Chargement Destinataire <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $get_demande="SELECT * FROM demande , vendeurs , colis_livre , livreurs WHERE vendeurs.vend_id=demande.vendeur_id AND demande.dmd_id=colis_livre.dmd_id AND livreurs.livreur_id=colis_livre.livreur_id  AND colis_livre.etat_lv='Reçu par MPacket' ";
                  ...
                  <tr>
                   ...
                   <td><a href=""><?php echo $code_bar; ?></a></td>
                    ...
                    <td></td>
                      ...
                      <td><a href="indexAdmin.php?colis_acheminement=<?php echo $id_livre; ?>">
                                     
                                        <i class="fa fa-trash-o"></i> Acheminement
