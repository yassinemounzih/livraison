               ...
               <a href="indexAdmin.php?Chargement_Destinataire"><button type="button"  class="btn btn-outline-primary">Chargement Destinataire <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                      ...
                      $get_demande="SELECT * FROM demande , vendeurs , colis_livre WHERE vendeurs.vend_id=demande.vendeur_id AND demande.dmd_id=colis_livre.dmd_id AND type='Livraison' AND demande.etat_dmd='ramasse' ";
