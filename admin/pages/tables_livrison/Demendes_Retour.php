            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <a href="indexAdmin.php?Chargement_Destinataire"><button type="button"  class="btn btn-outline-primary">Chargement Destinataire <span class="badge badge-danger right">0</span></button></a>
                 ...
                 <a href="indexAdmin.php?Demendes_Retour"><button type="button"  class="btn btn-primary">Demendes Retour <span class="badge badge-danger right">0</span></button></a>
               ...
               <br>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM demande , vendeurs , colis_livre , livreurs WHERE vendeurs.vend_id=demande.vendeur_id AND demande.dmd_id=colis_livre.dmd_id AND livreurs.livreur_id=colis_livre.livreur_id AND demande.type='Livraison' ANd colis_livre.etat_lv='Annulé, demande de retour' ";
                  ...
                  <tr>
                    ...
                    <ul>
                     ...
                     <a href="indexAdmin.php?colis_Retours_Envoyés=<?php echo $id_livre; ?>">
                                     
                   <i class="fa fa-trash-o"></i> Retours Envoyés! ! <br>
