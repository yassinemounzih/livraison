               ...
               <a href="index.php?Chargement_Destinataire"><button type="button"  class="btn btn-outline-primary">Chargement Destinataire <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM users, demande  ,colis_livre  WHERE users.user_id=demande.user_id_vend AND users.user_email='$email' AND demande.dmd_id=colis_livre.dmd_id and colis_livre.etat_lv='Annulé, retour reçu par MPacket' ";
