               ...
               <div>
                <a href=""><button type="button"  class="btn btn-outline-primary"> Colis Affectés <span class="badge badge-danger right">0</span> </button></a> 
                 ...
                 <a href=""><button type="button"  class="btn btn-outline-primary">En Attente de validation <span class="badge badge-danger right">0</span></button></a>
                   ...
                   <a href=""><button type="button"  class="btn btn-outline-primary">Packaging Validé <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM users, demande  ,colis_livre  WHERE users.user_id=demande.user_id_vend AND users.user_email='$email' AND demande.dmd_id=colis_livre.dmd_id and colis_livre.etat_lv='en attente de validation' AND demande.type='Livraison'";
