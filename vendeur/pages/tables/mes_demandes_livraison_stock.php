...
<a href="index.php?mes_demandes_livraison_stock"><button type="button"  class="btn btn-primary">En Attente de validation <span class="badge badge-danger right">0</span> </button></a> 
               ...
               <a href="index.php?Reçu_parAS"><button type="button"  class="btn btn-outline-primary">Mes Livraisons <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_livre="SELECT * FROM users , demande, colis_livre WHERE demande.dmd_id=colis_livre.dmd_id AND users.user_id=demande.user_id_vend AND users.user_email='$email' AND colis_livre.etat_lv='en attente de validation' AND demande.type='Livraison'";
