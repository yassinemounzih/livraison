               ...
               <a href="index.php?Reçu_parAS"><button type="button"  class="btn btn-outline-primary">Mes Livraisons <span class="badge badge-danger right">0</span></button></a>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $get_demande="SELECT * FROM demande , users  WHERE users.user_id=demande.user_id_vend AND  demande.type='Livraison' and users.user_email='$email' AND (demande.etat_dmd='no ramasse' OR demande.etat_dmd='ramasse')   order by 1 DESC";
