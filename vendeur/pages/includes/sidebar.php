...
?>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../index.php?contacts_ven" class="nav-link">Contact</a>
      </li>
    </ul>
       ...
       <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-footer">
            ...
            <a href="examples/logout.php" class="btn btn-default btn-flat float-right">Sign out</a>
          </li>
        </ul>
      </li>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?nouvelle_ramassage" class="nav-link">
               ...
               <li class="nav-item">
                <a href="index.php?livre_en_stock" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
                  <p>Mon Stock</p>
                </a>
              </li>
    ...
    <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="index.php?nouvelle_livraison" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
              ...
              <li class="nav-item">
                <a href="index.php?plus_livraison1" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
              ...
              <li class="nav-item">
                <a href="index.php?ramassages_pas_effectues" class="nav-link">
                  <i class="nav-icon far fa-circle text-info"></i>
                  <p>Mes Demandes</p>
                </a>
          ...
          <li class="nav-item has-treeview">
            <a href="index.php?Reçu_parAS" class="nav-link">
